...
_ECSGOGCMSG = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EMsgGCCStrike15_v2_GlobalChat', index=74, number=9180,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EMsgGCCStrike15_v2_GlobalChat_Subscribe', index=75, number=9181,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EMsgGCCStrike15_v2_GlobalChat_Unsubscribe', index=76, number=9182,
      options=None,
      type=None),
  ],
