...
try:
    from . import netmessages_pb2
except ImportError: 
    import netmessages_pb2
try:
    from . import cstrike15_gcmessages_pb2
except ImportError: 
...
CCSUsrMsg_ReportHit = _reflection.GeneratedProtocolMessageType('CCSUsrMsg_ReportHit', (_message.Message,),
    {
...
CCSUsrMsg_QuestProgress = _reflection.GeneratedProtocolMessageType('CCSUsrMsg_QuestProgress', (_message.Message,),
    {
...
CCSUsrMsg_XpUpdate = _reflection.GeneratedProtocolMessageType('CCSUsrMsg_XpUpdate', (_message.Message,),
    {
