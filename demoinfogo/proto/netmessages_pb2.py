...
CNETMsg_PlayerAvatarData = _reflection.GeneratedProtocolMessageType('CNETMsg_PlayerAvatarData', (_message.Message,),
    {
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), b('\200\001\000'))
_ESPLITSCREENMESSAGETYPE.has_options = True
_ESPLITSCREENMESSAGETYPE._options = _descriptor._ParseOptions(descriptor_pb2.EnumOptions(), b('\020\001'))
